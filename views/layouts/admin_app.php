...
<head>
    ...
    <title><?php echo $pageTitle ?? 'ระบบผู้ดูแลระบบ'; ?> | <?php echo $global['nameschool']; ?></title>
...
<body class="bg-rose-50/30 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen transition-colors duration-500">
    ...
    <div id="preloader" class="fixed inset-0 z-[100] flex items-center justify-center bg-white dark:bg-slate-950 transition-opacity duration-700">
        <div class="relative">
            <div class="w-24 h-24 border-4 border-rose-500/10 border-t-rose-600 rounded-full animate-spin"></div>
