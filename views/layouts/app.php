...
// Detect current path for proper asset URL handling
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $baseUrl ?? ''; ?>dist/css/style.css?v=20260916">
    ...
    <link rel="icon" type="image/png" href="<?php echo $baseUrl; ?>dist/img/<?php echo $global['logoLink'] ?? 'logo-phicha.png'; ?>">
</head>
...
<body class="font-mali bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 min-h-screen transition-colors duration-500">
    ...
    <div id="preloader" class="fixed inset-0 z-50 flex items-center justify-center bg-white dark:bg-slate-900 transition-opacity duration-500">
        <div class="text-center">
            <img src="<?php echo $baseUrl; ?>dist/img/<?php echo $global['logoLink'] ?? 'logo-phicha.png'; ?>" alt="Logo" class="w-24 h-24 mx-auto animate-bounce-slow">
            <div class="loader mx-auto mt-6"></div>
            <p class="mt-4 text-lg text-gray-600 dark:text-gray-300 animate-pulse"><?php echo $global['pageTitle'] ?? 'ระบบดูแลช่วยเหลือนักเรียน     '; ?></p>
        </div>
    </div>
