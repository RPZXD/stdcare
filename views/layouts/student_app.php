...
/**
 * Student Layout
 * MVC Pattern - Main layout template for student pages
 * Premium Design with Tailwind CSS & Responsive Components (Blue theme)
 */
...
// Ensure student data is in session
...
<head>
    ...
    <title><?php echo $pageTitle ?? 'ระบบนักเรียน'; ?> | <?php echo $global['nameschool']; ?></title>
...
<body class="bg-blue-50/30 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen transition-colors duration-500">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col lg:ml-64">
            <!-- Navbar -->
            <?php include __DIR__ . '/../components/student_navbar.php'; ?>
