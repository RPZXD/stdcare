...
<div class="relative mb-6 overflow-hidden fade-in-up">
    <div class="glass-card rounded-2xl md:rounded-3xl p-5 md:p-8 border border-white/40 dark:border-slate-700/50 shadow-2xl relative">
        <!-- Background Orbs -->
        <div class="absolute top-0 right-0 w-32 md:w-64 h-32 md:h-64 bg-gradient-to-br from-rose-400/30 to-pink-500/30 rounded-full blur-3xl -z-10"></div>
        <div class="absolute bottom-0 left-0 w-24 md:w-48 h-24 md:h-48 bg-gradient-to-tr from-red-400/30 to-orange-500/30 rounded-full blur-3xl -z-10"></div>
        
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <!-- Title -->
            <div class="flex items-center gap-3 md:gap-4">
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-br from-rose-500 to-red-600 rounded-2xl blur-xl opacity-60"></div>
                    <div class="relative w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-rose-500 to-red-600 rounded-2xl flex items-center justify-center shadow-2xl">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-rose-100 to-pink-100 dark:from-rose-900/40 dark:to-pink-900/40 text-rose-700 dark:text-rose-300 rounded-full font-bold text-sm shadow-sm">
                            <i class="fas fa-chalkboard-teacher"></i>
                            ม.<?php echo htmlspecialchars($class); ?>/<?php echo htmlspecialchars($room); ?>
                        </span>
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-orange-100 to-amber-100 dark:from-orange-900/40 dark:to-amber-900/40 text-orange-700 dark:text-orange-300 rounded-full font-bold text-sm shadow-sm">
            ...
            <div class="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
                <button onclick="openAddModal()" class="btn-action bg-gradient-to-r from-rose-500 to-red-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-rose-500/30 flex items-center justify-center gap-2">
                    <i class="fas fa-minus-circle"></i>
                    <span>หักคะแนน</span>
                </button>
                <a href="show_behavior.php" class="btn-action bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-blue-500/30 flex items-center justify-center gap-2 no-underline">
...
<div class="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4 mb-6">
    <div class="stat-card glass-card rounded-2xl p-4 md:p-5 border border-white/50 dark:border-slate-700/50 shadow-xl text-center group">
        <div class="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300">
            <i class="fas fa-users text-white text-xl"></i>
        </div>
        <p class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-600" id="totalStudents">0</p>
        <p class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-2">นักเรียนทั้งหมด</p>
    </div>
    
    <div class="stat-card glass-card rounded-2xl p-4 md:p-5 border border-white/50 dark:border-slate-700/50 shadow-xl text-center group">
        <div class="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-rose-400 to-red-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300">
            <i class="fas fa-minus-circle text-white text-xl"></i>
        </div>
        <p class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-red-600" id="totalDeduction">0</p>
        <p class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-2">รวมหัก</p>
    </div>
    
    <div class="stat-card glass-card rounded-2xl p-4 md:p-5 border border-white/50 dark:border-slate-700/50 shadow-xl text-center group">
        <div class="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-teal-400 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300">
            <i class="fas fa-hand-holding-heart text-white text-xl"></i>
        </div>
        <p class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-cyan-600" id="totalBonus">0</p>
        <p class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-2">จิตอาสา</p>
    </div>
    
    <div class="stat-card glass-card rounded-2xl p-4 md:p-5 border border-white/50 dark:border-slate-700/50 shadow-xl text-center group">
        <div class="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-amber-400 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300">
            <i class="fas fa-exclamation-triangle text-white text-xl"></i>
        </div>
        <p class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600" id="studentWithDeduct">0</p>
        <p class="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-2">ถูกหักคะแนน</p>
    </div>
    
    <div class="stat-card glass-card rounded-2xl p-4 md:p-5 border border-white/50 dark:border-slate-700/50 shadow-xl text-center group">
        <div class="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-emerald-400 to-green-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-all duration-300">
            <i class="fas fa-check-circle text-white text-xl"></i>
        </div>
        <p class="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-green-600" id="studentGood">0</p>
...
<div class="glass-card rounded-2xl border border-white/50 dark:border-slate-700/50 shadow-xl overflow-hidden mb-6">
    ...
    <div id="studentGrid" class="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <!-- Loading Skeleton -->
        <div class="skeleton-card glass-card rounded-xl p-4 border border-slate-200 dark:border-slate-700 animate-pulse">
    ...
    <div id="emptyState" class="hidden p-12 text-center">
        <div class="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 rounded-full flex items-center justify-center">
...
<div class="glass-card rounded-2xl border border-amber-200 dark:border-amber-800/50 shadow-xl overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20">
    ...
    <div class="p-5 space-y-3">
        <div class="flex items-center gap-3 p-3 bg-red-100 dark:bg-red-900/30 rounded-xl border border-red-200 dark:border-red-800">
            <div class="w-10 h-10 bg-red-500 rounded-lg flex items-center justify-center">
                <i class="fas fa-exclamation-circle text-white"></i>
            </div>
            <div>
                <p class="font-bold text-red-700 dark:text-red-300">กลุ่มที่ 1: คะแนนต่ำกว่า 50</p>
                <p class="text-sm text-red-600 dark:text-red-400">เข้าค่ายปรับพฤติกรรม (กลุ่มบริหารงานกิจการนักเรียน)</p>
            </div>
        </div>
        <div class="flex items-center gap-3 p-3 bg-orange-100 dark:bg-orange-900/30 rounded-xl border border-orange-200 dark:border-orange-800">
        ...
        <div class="flex items-center gap-3 p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-xl border border-yellow-200 dark:border-yellow-800">
...
<div id="addModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="relative w-full max-w-lg bg-white dark:bg-slate-800 rounded-3xl shadow-2xl transform transition-all">
            <!-- Modal Header -->
            <div class="p-6 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-rose-500 to-red-600 rounded-t-3xl">
                ...
                <form id="addBehaviorForm">
                    <div class="space-y-5">
                        ...
                        <div class="relative">
                            ...
                            <div id="searchResults" class="absolute z-10 w-full mt-2 bg-white dark:bg-slate-700 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-600 max-h-64 overflow-y-auto hidden">
                        ...
                        <div id="selectedStudent" class="hidden">
                            <div class="p-4 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-xl border-2 border-emerald-200 dark:border-emerald-700">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-4">
                                        <div id="selectedStudentAvatar" class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-white text-xl shadow-lg">
                                            <i class="fas fa-user"></i>
                                        </div>
                                        <div>
                                            <h4 id="selectedStudentName" class="font-bold text-slate-800 dark:text-white text-lg"></h4>
                                            <p id="selectedStudentInfo" class="text-sm text-slate-600 dark:text-slate-400"></p>
                                        </div>
                                    </div>
                                    <button type="button" onclick="clearSelectedStudent()" class="p-2 text-slate-400 hover:text-red-500 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg transition">
                        ...
                        <!-- No Student Warning -->
                        <div id="noStudentWarning" class="p-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-xl text-amber-700 dark:text-amber-300 text-sm flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <select id="addType" name="addBehavior_type"
                                ...
                                <option value="<?php echo htmlspecialchars($type); ?>" data-score="<?php echo $score; ?>">
                        ...
                        <!-- Score Display -->
                        <div class="p-4 bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 rounded-xl border-2 border-red-200 dark:border-red-700">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-bold text-red-700 dark:text-red-300">
                                    <i class="fas fa-minus-circle mr-1"></i>
                                    คะแนนที่หัก
                                </span>
                                <span id="addScoreDisplay" class="text-3xl font-black text-red-600 dark:text-red-400">0</span>
                            </div>
            ...
            <div class="p-6 border-t border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row gap-3">
                <button onclick="closeAddModal()" class="flex-1 btn-action py-3.5 px-6 bg-slate-100 dark:bg-slate-600 text-slate-700 dark:text-slate-200 rounded-xl font-bold hover:bg-slate-200 dark:hover:bg-slate-500 transition">
                    <i class="fas fa-times mr-2"></i>ยกเลิก
                </button>
                <button onclick="submitBehavior()" id="submitBtn" class="flex-1 btn-action py-3.5 px-6 bg-gradient-to-r from-rose-500 to-red-600 text-white rounded-xl font-bold shadow-lg hover:shadow-rose-500/30 transition disabled:opacity-50 disabled:cursor-not-allowed">
...
<div id="viewModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="relative w-full max-w-2xl bg-white dark:bg-slate-800 rounded-3xl shadow-2xl transform transition-all">
            <!-- Modal Header -->
            ...
            <div class="p-6 border-t border-slate-200 dark:border-slate-700">
                <button onclick="closeViewModal()" class="w-full btn-action py-3 px-6 bg-slate-200 dark:bg-slate-600 text-slate-700 dark:text-slate-200 rounded-xl font-bold">
