...
$(document).ready(function() {
    ...
    $('#teacherTable').on('click', '.editTeacherBtn', async function() {
        ...
        if (data && data.Teach_id) {
            ...
            $('[name="editTeach_email"]').val(data.Teach_email || '');
            $('[name="editTeach_sex"]').val(data.Teach_sex || '');
            $('[name="editTeach_Position2"]').val(data.Teach_Position2 || '');
            $('[name="editTeach_HiDegree"]').val(data.Teach_HiDegree || '');
