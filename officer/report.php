        ...
        <section class="content">
            <div class="container mx-auto py-4">
                ...
                $tabFiles = [
                    ...
                    // เพิ่มเมนูรายงานห้องเรียนสีขาวทุกแบบ
                    'whiteclass' => 'report_whiteclass.php', // สรุปภาพรวมทุกห้อง
                    'whiteclass-list' => 'report_whiteclass_list.php', // รายชื่อคณะกรรมการแต่ละห้อง
                    'whiteclass-structure' => 'report_whiteclass_structure.php', // ผังโครงสร้างแต่ละห้อง
                ];
                ...
                $moreTabs = [
                    ['parent-leader', '👨‍👩‍👧‍👦 ประธานเครือข่าย', 'purple'],
                    ['sdq_room', '🧠 SDQ (รายห้อง)', 'red'],
                    ['sdq_class', '🧠 SDQ (รายชั้น)', 'red'],
                    ['sdq_school', '🧠 SDQ (โรงเรียน)', 'red'],
                    ['eq_room', '💡 EQ (รายห้อง)', 'orange'],
                    ['eq_class', '💡 EQ (รายชั้น)', 'orange'],
                    ['eq_school', '💡 EQ (โรงเรียน)', 'orange'],
                    ['screen11_room', '🔬 11 ด้าน (รายห้อง)', 'teal'],
                    ['screen11_class', '🔬 11 ด้าน (รายชั้น)', 'teal'],
                    ['screen11_school', '🔬 11 ด้าน (โรงเรียน)', 'teal'],
                    // เพิ่มเมนูย่อยห้องเรียนสีขาว
                    ['whiteclass', '⚪ ห้องเรียนสีขาว (สรุป)', 'gray'],
                    ['whiteclass-list', '📋 ห้องเรียนสีขาว (รายชื่อ)', 'gray'],
                    ['whiteclass-structure', '🏠 ห้องเรียนสีขาว (ผังโครงสร้าง)', 'gray'],
                ];
                ?>
                <!-- Tabs -->
