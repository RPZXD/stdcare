<?php
/**
 * API: SDQ Result Summary by Class Level
...
$totalAll = $classSummary['total'];
$totalHave = $classSummary['have'];
$totalNormal = $classSummary['normal'];
$totalRisk = $classSummary['risk'];
$totalProblem = $classSummary['problem'];
        ...
        <div class="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            ...
            <div class="flex flex-col items-center shrink-0">
                ...
                <div class="mt-4 text-center">
                    <p class="text-[11px] font-black text-rose-500 uppercase tracking-widest italic">ประเมินแล้ว <?= $totalHave ?> / <?= $totalAll ?> คน</p>
                </div>
            </div>
            ...
            <tr class="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all">
                <td class="px-6 py-5 rounded-l-2xl bg-white dark:bg-slate-900 shadow-sm border-y border-l border-slate-100 dark:border-slate-800" data-label="ห้องเรียน">
                    <div class="flex items-center gap-4">
                        <span class="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-rose-500 text-[13px] font-black italic"><?= $r ?></span>
