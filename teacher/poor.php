        ...
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                <img src="../dist/img/logo-phicha.png" alt="Phichai Logo" class="brand-image rounded-full opacity-80 mb-3 w-12 h-12 mx-auto">
                        <h5 class="text-center text-lg">ข้อมูลนักเรียนยากจน<br></h5>
                    ...
                    <button type="button" id="addButton" class="btn bg-pink-500 text-white text-left mb-3 mt-2" data-toggle="modal" data-target="#addModal">
                    <i class="fas fa-plus"></i> เพิ่มข้อมูลนักเรียนยากจน <i class="fas fa-plus"></i></button>
                        ...
                        <div class="col-md-12 mt-3 mb-3 mx-auto">
                            ...
                            <thead class="thead-secondary bg-indigo-500 text-white">
                                <tr>
                                            ...
                                            <th  class="text-center">การได้รับทุน</th>
                                            <th  class="text-center">ข้อมูลเยี่ยมบ้าน</th>
...
$(document).ready(function() {
    ...
    async function loadTable(classId, roomId) {
        try {
            const response = await $.ajax({
                url: 'api/fetch_poor_classroom.php',
                method: 'GET',
                dataType: 'json',
                data: { class: classId, room: roomId }
            });
