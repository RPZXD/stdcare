...
<form id="screenForm" method="POST" class="space-y-6">
    ...
    <div class="flex justify-end mt-6">
        <button type="submit" id="saveScreen" class="bg-green-600 text-white px-6 py-2 rounded hidden">บันทึกข้อมูล</button>
    </div>
