...
try {
    ...
    // ============================================================
    // ส่วนที่ 1.5: หักคะแนนพฤติกรรมนักเรียนขาดเรียน (วันละ 1 ครั้ง) -> ยกเลิกการหักคะแนนตามความต้องการ
    // ============================================================
    echo "\n--- Processing Absent Student Behavior Deduction (Bypassed) ---\n";
    echo "ระบบยกเลิกการหักคะแนนพฤติกรรมสำหรับนักเรียนที่ขาดเรียนจากการตัดอัตโนมัติเรียบร้อยแล้ว\n";
    /*
