...
<div class="flex flex-wrap -mx-4 mb-4">
    ...
    <div class="w-full px-4">
        <div class="card border rounded-lg shadow-sm p-4 mb-4 bg-blue-200">
            <div class="card-body">
...
<div class="bg-white border rounded-lg shadow-md p-4">
    ...
    <span class="inline-block bg-green-500 text-white text-sm font-semibold px-2 py-1 rounded">
        <?= $totalProblemScore > 20 ? 'มีปัญหา' : ($totalProblemScore >= 15 ? 'ภาวะเสี่ยง' : 'ไม่มีปัญหา') ?>
    </span>
    ในด้านใดด้านหนึ่ง 
