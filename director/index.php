 ...
 * MVC Pattern - Handles authentication and data aggregation for the director dashboard
 */
session_start();
...
// (6) Set Page Metadata
$pageTitle = 'Director Dashboard - ระบบดูแลช่วยเหลือนักเรียน';
$activePage = 'dashboard';

// (7) Render View
include __DIR__ . '/../views/director/index.php';
?>
